...
export type { A2UiVueRendererOptions, CatalogRegistration, } from './A2UIRendererPlugin';
...
export { BASIC_CATALOG_ID, VANT_CATALOG_ID, DEFAULT_CATALOG_ID, } from './core/constants';
export { registerBasicCatalog, registerVantCatalog, registerCatalogDefinition, } from './core/defaultCatalog';
...
export { BASIC_COMPONENTS, BASIC_FUNCTIONS, BASIC_THEME_SCHEMA, VANT_COMPONENTS, VANT_FUNCTIONS, VANT_THEME_SCHEMA, basicCatalogSchema, vantCatalogSchema, } from './catalog';
